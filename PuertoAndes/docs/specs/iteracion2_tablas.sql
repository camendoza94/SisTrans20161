...
ID_BUQUE INTEGER,
FECHA DATE NOT NULL,
PUERTO_ACTUAL INTEGER,
PUERTO_ANTERIOR INTEGER NOT NULL,
PUERTO_SIGUIENTE INTEGER NOT NULL,
CONSTRAINT PK_AB_ARRIBO_BUQUES PRIMARY KEY (ID_BUQUE,PUERTO_ACTUAL,FECHA),
CONSTRAINT FK_AB_ID_BUQUE FOREIGN KEY (ID_BUQUE)
   REFERENCES BUQUES(ID_BUQUE),
CONSTRAINT FK_PUERTO_ANTERIOR FOREIGN KEY (PUERTO_ANTERIOR)
   REFERENCES PUERTOS (ID_PUERTO),
CONSTRAINT FK_PUAC_PUERTO_ACTUAL FOREIGN KEY (PUERTO_ACTUAL)
  REFERENCES PUERTOS (ID_PUERTO),
CONSTRAINT FK_PUERTO_SIGUIENTE FOREIGN KEY (PUERTO_SIGUIENTE)
   REFERENCES PUERTOS (ID_PUERTO)
);

CREATE TABLE SALIDA_BUQUES(
ID_BUQUE INTEGER,
ID_PUERTO_ACTUAL INTEGER,
FECHA DATE NOT NULL,
CONSTRAINT PK_SALIDA_BUQUE PRIMARY KEY(ID_BUQUE, ID_PUERTO_ACTUAL, FECHA),
CONSTRAINT FK_SB_ID_BUQUE FOREIGN KEY (ID_BUQUE)
     REFERENCES BUQUES (ID_BUQUE)
CONSTRAINT FK_PUA_ID_PUERTO_ACTUAL FOREIGN KEY(ID_PUERTO_ACTUAL)
        REFERENCES PUERTOS(ID_PUERTO)
);
